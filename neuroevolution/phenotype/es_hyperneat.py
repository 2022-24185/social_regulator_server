...
import neat
import numpy as np
from neuroevolution.phenotype.hyperneat import query_cppn
from neuroevolution.shared.visualize import draw_es
...
class ESNetwork:
    ...
    def __print__(self):
        ...
        print("cppn", self.cppn)
        print("initial_depth", self.initial_depth)
        print("max_depth", self.max_depth)
        print("variance_threshold", self.variance_threshold)
        print("band_threshold", self.band_threshold)
        print("iteration_level", self.iteration_level)
        print("division_threshold", self.division_threshold)
    ...
    def create_phenotype_network(self, filename=None):
        ...
        network = neat.nn.RecurrentNetwork(input_nodes, output_nodes, node_evals)
        network.activations = self.activations
        return network
